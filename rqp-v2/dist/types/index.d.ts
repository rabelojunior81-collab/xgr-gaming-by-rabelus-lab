...
export type AgentCode = 'ORCH-000' | 'DISC-001' | 'SPEC-001' | 'ARCH-001' | 'IMPL-001' | 'VALD-001' | 'RETR-001' | 'BUGF-001' | 'SECR-001';
...
export type GatePhase = 'discovery' | 'specification' | 'architect' | 'implementation' | 'validation' | 'release';
