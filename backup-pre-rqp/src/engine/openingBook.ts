...
import { OPENINGS, OPENING_CATEGORIES } from '@/data/openings';
import type { OpeningData, BookMove, OpeningCategory, OpeningBookStats } from '@/types/chess';
...
export class OpeningBook {
   ...
   */
  private findEcoCode(fen: string, move: string): string | undefined {
