...
import { OpeningBook, getOpeningBook, resetOpeningBook } from '@/engine/openingBook';
import { OPENINGS, OPENING_CATEGORIES, getOpeningsByPersonality } from '@/data/openings';
import type { AIPersonality, BookMove, OpeningData } from '@/types/chess';
...
describe('OpeningBook', () => {
  ...
  describe('Lookup', () => {
    ...
    it('deve retornar null para posição desconhecida', () => {
      const unknownFen = 'rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3';
      // Esta posição pode ou não estar no livro dependendo da abertura
      // Mas posições absurdas devem retornar null
