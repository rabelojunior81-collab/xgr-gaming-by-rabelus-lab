...
export function GameControls() {
  ...
  return (
    <div className="flex h-full flex-col bg-slate-900/95 p-4 text-white" data-testid="game-controls-panel">
      {/* Header */}
      ...
      <div className="mb-4" data-testid="emotional-indicator-panel">
        <EmotionalIndicator
