...
import type { GameMode } from '@shared/types/chess';
...
function MenuCard({ title, description, icon, mode, color, delay, testId }: MenuCardProps) {
...
export function MainMenu() {
  return (
    <div data-testid="main-menu" className="flex min-h-screen flex-col bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8">
      {/* Header */}
      <motion.div
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
