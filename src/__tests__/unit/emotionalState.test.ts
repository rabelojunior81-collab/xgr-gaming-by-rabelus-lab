...
import { EmotionalStateManager } from '@ai/engine/emotionalState';
import type { AIPersonality, EmotionalState } from '@shared/types/chess';
...
describe('EmotionalStateManager', () => {
  ...
  describe('Ajustes de thresholds por personalidade', () => {
    ...
    it('aggressive personality permanece concerned onde solid seria desperate', () => {
      ...
      expect(solidProfile.state).toBeTruthy();
    });
  });
